...
public class ChannelSetupMessage extends EisMessage {
    private static final byte EIS_CHANNEL_ID_TYPE = 0x01;
    private short eisChannelId;

    public ChannelSetupMessage(short eisChannelId) {
    ...
    public byte[] serialize() {
        ...
        // Header
        buffer.put(VERSION);
        buffer.putShort((short) EISMessageType.CHANNEL_SETUP.getType());
